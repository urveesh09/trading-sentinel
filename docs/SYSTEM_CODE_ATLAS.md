...
Top-level declarations: `ShadowProposal` (line 64), `ShadowSimulation` (line 83), `ShadowAllocation` (line 97), `ShadowPosition` (line 107), `_proposal_id` (line 125), `shadow_history_state` (line 129), `build_shadow_proposals` (line 154), `allocate_shadow_proposals` (line 201), `size_shadow_allocations` (line 218), `_comparable_shadow_score` (line 277), `simulate_shadow_trade` (line 291), `_simulate_shadow_limit_pullback` (line 347), `_simulate_shadow_trailing_stop` (line 399), `simulate_shadow_research_trial` (line 471), `_normalise_shadow_bars` (line 516), `_bars_visible_as_of` (line 539), `_shadow_entry_window_already_observed` (line 560), `simulate_open_shadow_position` (line 580), `_stamp` (line 687), `init_proactive_intelligence` (line 694), `_shadow_run_storage_key` (line 715), `_shadow_implementation_identity` (line 740), `stamp_session_phase` (line 745), `_configured_shadow_run_id` (line 765), `_ensure_shadow_run` (line 780), `_shadow_run_manifest` (line 845), `_claim_shadow_step` (line 862), `_complete_shadow_step` (line 932), `record_opportunity_event` (line 953), `_record_opportunity_event_in_transaction` (line 983), `transition_watchlist` (line 1022), `record_cash_flow` (line 1049), `record_scan_run` (line 1070), `record_market_data_observation` (line 1090), `proactive_inactivity_diagnostics` (line 1139), `_recent_eligible_session_dates` (line 1171), `proactive_session_diagnostics` (line 1191), `_shadow_positions` (line 1327), `_shadow_account_state` (line 1351), `_persist_new_shadow_position` (line 1373), `_advance_open_shadow_positions` (line 1433), `_complete_shadow_watchlist_in_transaction` (line 1494), `_expire_pending_shadow_watchlists` (line 1512), `repair_shadow_evidence` (line 1553), `run_shadow_workflow` (line 1590), `run_shadow_replay` (line 1801), `_record_shadow_configuration_state` (line 1816), `_validate_shadow_bar_collections` (line 1828), `run_configured_shadow_workflow` (line 1849), `proactive_activity_report` (line 1993), `proactive_shadow_comparison` (line 2111), `_research_proposal_manifest` (line 2224), `run_shadow_research_comparison` (line 2234), `proactive_shadow_research_report` (line 2338)
