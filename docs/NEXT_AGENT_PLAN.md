...
| C — replay fidelity/review integration | IMPLEMENTING | Real evaluator/archive multi-session fixture reaches costed close/unresolved outcomes; conflicts are rejected; source-bound reports carry baseline/stress scenarios into close-ordered drawdown and criteria frozen before holdout | Finish source scope/roll context and remaining delayed/partial execution and exact-expiry boundaries; obtain adequate real held-out evidence |
